...
def ResNet18Small(num_classes=10):
    ...
    model.conv1 = nn.Conv2d(3, model.inplanes, kernel_size=3, stride=1, padding=1, bias=False)
    model.fc = nn.Linear(512, num_classes)
    return model


# resnet18_small is the name of entrypoint
...
if __name__ == "__main__":
    ...
    model = resnet34_cifar10(weights=True)
